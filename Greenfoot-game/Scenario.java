...
public class Scenario extends World
{
     ...
     */
     ...
     List<BulletFromEnemy> enemybullets=new ArrayList<BulletFromEnemy>();
     Enemy enemy=new Kekda(100,200);
...
//    Enemy enemy2=new Enemy();
    ...
    {    
        ...
        switch(str[0]){
          case"M":play1 =new Macrole(true,this,30);break;
          case"P":play1 =new Pinarole(true,this,30);break;
          case"S":play1 =new Sierrarole(true,this,30);break;
          default:break;
        }
        switch(str[1]){
          case"M":play2 =new Macrole(false,this,30);break;
          case"P":play2 =new Pinarole(false,this,30);break;
          case"S":play2 =new Sierrarole(false,this,30);break;
          default:break;
        }
        prepare();
        act();
    ...
    public void act() {
        ...
        if(enemybullets.size()>0){
            for(int i=0; i<enemybullets.size();i++){
                BulletFromEnemy bul=enemybullets.get(i);
//                bul.hitRole(monkey);
            }
        }
